...
View saved requests in the Site settings database viewer, in the `demo_requests` table. The website currently has no admin dashboard or automatic email notifications.
